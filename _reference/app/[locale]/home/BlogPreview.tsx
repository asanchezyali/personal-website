    ...
    <div className="mx-auto space-y-12 py-16">
      <div className="relative">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-1/4 top-1/2 h-32 w-32 -translate-x-1/2 transform rounded-full bg-primary-300/20 blur-2xl dark:bg-primary-700/20" />
          <div className="absolute right-1/4 top-1/2 h-32 w-32 translate-x-1/2 transform rounded-full bg-secondary-300/20 blur-2xl dark:bg-secondary-700/20" />
        </div>
      ...
      <ListLayout params={{ locale: locale }} posts={filteredPosts.slice(0, 3)} title={t('all')} />
    </div>
  )
}
