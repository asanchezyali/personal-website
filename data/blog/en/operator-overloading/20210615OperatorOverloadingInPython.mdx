...
<ImageBox
  ...
  height="350px"
>
  **Figura 1**. Clocks - Arithmetic Modular 24 Operation.
</ImageBox>
...
<div className="px-4 text-sm italic text-gray-50">
...
1. This article was originally published on the Monadical Blog: [Operator Overloading in Python](https://monadical.com/posts/operator-overloading-in-python.html).
2. [Python Data Model.](https://docs.python.org/3/reference/datamodel.html#data-model)
3. [Special Method names.](https://docs.python.org/3/reference/datamodel.html#special-method-names)
4. [Operators.](https://docs.python.org/3/library/operator.html)
