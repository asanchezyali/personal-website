...
date: '2022/10/05'
tags: ['python', 'operator-overloading', 'number-theory', 'lights out game']
draft: false
time: '18 min'
summary: 'In this tutorial, we are going to learn how to create a library for modular arithmetic, using operator overloading and redefining the built-in functions for NumPy.'
bibliography: references-data.bib
canonicalUrl: 'https://www.asanchezyali.com/blog/en/modular-arithmetic/20220510ModularArithmetic'
headerImage: '/images/modular-arithmetic-library/header.webp'
language: 'en'
---

_Written by Alejandro Sánchez Yalí. Originally published 2022-10-05 on the [Monadical blog](https://monadical.com/blog.html)._
...
<ImageBox
  ...
  height="250px"
>
  **Figura 1**. Lights Out Game. Madsen, 2010.
  [Source](http://cau.ac.kr/~mhhgtx/courses/LinearAlgebra/references/MadsenLightsOut.pdf).
</ImageBox>
...
<ImageBox
  ...
  alt="Clock arithmetic"
  width="700px"
  height="300px"
>
  **Figura 2**. Clock arithmetic. University Waterloo, 2019.
  [source](https://www.cemc.uwaterloo.ca/events/mathcircles/2019-20/Fall/Junior78_Nov12_Soln.pdf).
</ImageBox>
...
<ImageBox
  ...
  height="300px"
>
  **Figura 3**. Clock arithmetic. University Waterloo, 2019.
  [Source](https://www.cemc.uwaterloo.ca/events/mathcircles/2019-20/Fall/Junior78_Nov12_Soln.pdf).
</ImageBox>
...
<ImageBox
  ...
  height="400px"
>
  **Figura 4**. Clock arithmetic. University Waterloo, 2019.
  [Source](https://www.cemc.uwaterloo.ca/events/mathcircles/2019-20/Fall/Junior78_Nov12_Soln.pdf).
</ImageBox>
...
<ImageBox
  ...
  height="450px"
>
  **Figura 5**. Clock arithmetic. University Waterloo, 2019.
  [Source](https://www.cemc.uwaterloo.ca/events/mathcircles/2019-20/Fall/Junior78_Nov12_Soln.pdf).
</ImageBox>
...
Now, let's look at how I used modular arithmetic to build a library that allows me to model the lights in Lights Out as
a cyclic sequence of states. Let’s get started!
...
[Classgap](https://www.classgap.com/es-co/tutor/alejandro-sanchez-yali), you can check our available schedules and
