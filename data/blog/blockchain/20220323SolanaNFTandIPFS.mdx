...
date: '2022/03/23'
lastmod: '2021/02/01'
tags: ['solana', 'nft','ipfs', 'metaplex', 'propiedad-digital']
draft: false
...
![CandiMachine](/images/candymachine.png#center 'Figura 1. User Interface')
...
![CandiMachine](/images/candymachine1.png#center 'Figura 2. Botón para acuñar un NFT')
...
![Wallet](/images/wallet.png#center 'Figura 3. NFTs apostillados en la Wallet personalizada')
