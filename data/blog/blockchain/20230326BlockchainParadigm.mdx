...
![Blockchain](/images/blockchain2.png#center 'Figura 2. Las transacciones son recopiladas y agrupadas en bloques. Cada bloque contiene un paquete de datos.')
...
$$
\begin{equation}
\pi(\sigma, B) = \Omega(B, \Gamma(\Gamma(\sigma, T_0), T_1), \dots)
\end{equation}
$$
...
![Blockchain](/images/blockchain3.png#center 'Figura 3. Desde el punto de vista de los estados. Una blockchain puede ser entendida como una cadena de estados.')
