...
guiarían el desarrollo de la criptografía moderna en su seminal artículo ["Communication Theory of Secrecy Systems"](https://pages.cs.wisc.edu/~rist/642-spring-2014/shannon-secrecy.pdf).

Shannon introdujo cuatro conceptos clave que transformarían la disciplina:

- **Entropía**: Mide la incertidumbre en un sistema de cifrado. Un sistema con alta entropía es más seguro que uno con
  baja entropía.
- **Confusión**: Una técnica que hace que la relación entre el texto cifrado y la clave sea lo más compleja posible. Un sistema con alta
  confusión es más difícil de descifrar.
- **Difusión**: Una técnica que busca distribuir la información del mensaje original a lo largo del texto cifrado, aumentando la resistencia a
  ataques analíticos. Un sistema con alta
  difusión es más resistente a ataques.
- **Seguridad perfecta**: Se refiere a un sistema de cifrado en el cual el texto cifrado no da ninguna pista sobre el
  mensaje original, incluso si el atacante tiene acceso a múltiples mensajes cifrados.

Estos principios teóricos sentaron las bases para el desarrollo de algoritmos de cifrado modernos y la teoría de la información, elementos fundamentales en la era digital actual.
