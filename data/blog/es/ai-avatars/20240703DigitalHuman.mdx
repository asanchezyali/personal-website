---
title: 'Revoluciona la animación: construye un humano digital con LLMs'
subtitle: 'Una Guía paso a paso para crear tu próximo avatar impulsado por IA.'
date: '2024/07/03'
lastmod: '2024-07-03'
tags: ['avatar-ia', 'humano-digital', 'inteligencia artificial', 'llm', 'lipsync']
draft: false
summary: 'Una Guía paso a paso para crear tu próximo avatar impulsado por IA.'
layout: PostLayout
bibliography: references-data.bib
canonicalUrl: 'https://www.asanchezyali.com/blog/es/ai-avatars/20240703DigitalHuman'
headerImage: '/images/ai-avatars/header-post2.png'
images: ['/images/ai-avatars/header-post2.png']
language: 'es'
authors:
...
<div className="text-center text-sm italic text-gray-500">
  Escrito por Alejandro Sánchez Yalí con Jenalee Prentice. Publicado originalmente el 2024-07-03 en
  el <a href="https://monadical.com/blog.html">blog de Monadical</a>.
</div>

## Introducción

Hay una nueva generación de avatares en escena, comúnmente conocidos como humanos digitales o avatares de IA[^1]. Estos
avatares han ganado este nombre algo serio porque simulan la apariencia y el comportamiento humano de una manera
notablemente realista. Por ejemplo, a menudo están diseñados con rasgos imperfectos, como un tono de piel desigual o una
cara asimétrica. También imitan las habilidades de lenguaje natural de los humanos simulando movimientos y señales no
verbales a través del análisis de sentimientos generado por LLM (_Large Language Models_)[^2].
...
En mi tutorial anterior, [El código Kraken: cómo construir un ai-avatar parlante](https://monadical.com/posts/how-to-build-a-talking-avatar-with-azure-cognitive-langchain-and-openai.html), expliqué cómo implementar un ai-avatar parlante en 2D. Esta vez, subiremos la apuesta y aprenderemos cómo implementar un avatar de IA parlante en 3D con características mejoradas.
...
- **Movimientos corporales naturales:** Para generar algunos movimientos corporales del avatar, utilizaremos [Mixamo](https://www.mixamo.com/). En cuanto a sincronizar la voz con movimientos de boca suaves y naturales, utilizaremos [Rhubarb lip-sync](https://github.com/DanielSWolf/rhubarb-lip-sync/releases). Es un CLI que genera [fonemas](https://en.wikipedia.org/wiki/Phoneme) localmente, y luego lo usamos para sincronizar los movimientos de la boca con la voz.

- **Texto a voz (TTS):** La tecnología de texto a voz (TTS) ha avanzado mucho desde los primeros días de asistentes de
  voz como el [Agente de Microsoft](https://en.wikipedia.org/wiki/Microsoft_Agent) y
  [DECtalk](https://en.wikipedia.org/wiki/DECtalk) en la década de 1990. Hoy en día, TTS puede producir voces realistas
  en todos los idiomas. Se puede utilizar esta tecnología para generar un habla convincente y natural si se combina con
  sincronización labial. En este caso, utilizaremos [ElevenLabs](https://elevenlabs.io/), un servicio de texto a voz
  multilingüe.
...
1.  **Defeated:** Mostrando frustración después de una pérdida
2.  **Angry:** De pie enojado
3.  **Idle:** Detenido, sin hacer nada

4.  **Idle:** Inactivo feliz

5.  **Surprised:** Encontrando algo y moviendo los dedos

6.  **Thoughtful headshake:** Sacudiendo la cabeza pensativamente

7.  **Dismissing gesture:** Descartando con el dorso de la mano

8.  **Talking One:** Hablando con dos manos

9.  **Talking Two:** Hablando con una mano

10. **Sad idle:** De pie en una disposición triste
...
<Reference
  type="web"
  url="https://www.digitalhumans.com/blog/how-chatgpt-bard-and-other-llms-are-signaling-an-evolution-for-ai-digital-humans"
  text="How ChatGPT, Bard and other LLMs are signalling an evolution for AI digital humans."
/>

<Reference type="web" url="https://www.digitalhumans.com/" text="UnneQ Digital Humans." />

<Reference
  type="web"
  url="https://www.linkedin.com/pulse/llms-building-less-artificial-more-intelligent-ai-human/"
  text="LLMs: Building a Less Artificial and More Intelligent AI Human."
/>

<Reference
  type="web"
  url="https://fcatalyst.com/blog/aug2023/building-a-digital-person-design-best-practices"
  text="Building a digital person design best practices."
/>

<Reference
  type="web"
  url="https://www.linkedin.com/pulsenavigating-era-digital-humans-initial-exploration-future-koelmel-eqrje/"
  text="Navigating the Era of Digital Humans: An Initial Exploration of a Future Concept."
/>

<Reference
  type="web"
  url="https://dev.to/david_bilsonn/how-to-setup-tailwind-css-in-react-js-with-vs-code-59p4"
  text="How to Setup Tailwind CSS in React JS with VS Code."
/>

<Reference type="web" url="https://exh.ai/#home" text="Ex-Human." />

<Reference type="github" url="https://github.com/xinjli/allosaurus" text="Allosaurus." />
...
<Reference
  type="web"
  url="https://docs.readyplayer.me/ready-player-me/api-reference/avatars/morph-targets/oculus-ovr-libsync"
  text="Ready Player Me - Oculus OVR LipSync."
/>

<Reference
  type="web"
  url="https://docs.readyplayer.me/ready-player-me/api-reference/avatars/morph-targets/apple-arkit"
  text="Ready Player Me - Apple Arkit."
/>

<Reference
  type="youtube"
  url="https://www.youtube.com/watch?v=EzzcEL_1o9o&t=321s"
  text="How to Build a 3D Chatbot with ChatGPT & ElevenLabs."
/>
