...
En un **programa computacional genérico**, las funciones intermedias pueden depender de las salidas de otras funciones. Tales dependencias
pueden ser representadas como un DAG. Un **grafo dirigido** $G = (V, E)$ consiste de un
conjunto de nodos $V$ y un conjunto de aristas $E\subseteq V \times V.$ Un arista $(u, v) \in E$ es un par ordenado de
vertices $u, v\in V$. Una arista también es representada como $u \to v.$, para indicar que $v$ depende de $u.$ Para representar las
