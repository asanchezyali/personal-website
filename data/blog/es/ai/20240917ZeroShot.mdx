...
y se conoce como [_Zero-Shot Learning_](https://en.wikipedia.org/wiki/Zero-shot_learning) (ZSL) o Aprendizaje de Cero
Disparos. En este artículo, exploraremos cómo los modelos de lenguaje pueden realizar clasificaciones de texto sin
...
<ImageBox src="/images/ai/zero-shot-v03.png" alt="Precisión por clase" width="728px" height="468px">
  **Figura 3**. Precisión por clase en la clasificación _Zero-Shot_ de noticias AG.
</ImageBox>
