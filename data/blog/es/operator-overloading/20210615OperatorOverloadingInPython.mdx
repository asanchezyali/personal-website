...
canonicalUrl: 'https://www.asanchezyali.com/blog/es/sobrecarga-de-operadores/20210615SobrecargaDeOperadoresEnPython'
...
- Austin Connolly - [8 Mejores Software de Seguimiento de Tiempo para Pequeñas Empresas en 2024](https://hubstaff.com/blog/time-tracking-software-for-small-business/).

## Referencias

1. [Modelo de Datos de Python.](https://docs.python.org/3/reference/datamodel.html#data-model)
2. [Nombres de Métodos Especiales.](https://docs.python.org/3/reference/datamodel.html#special-method-names)
3. [Operadores.](https://docs.python.org/3/library/operator.html)
