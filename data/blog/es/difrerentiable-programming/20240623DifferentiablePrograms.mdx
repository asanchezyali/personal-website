...
<PseudoCode title="Algoritmo 1. Programa computacional como un DAG">
  <PseudoCodeLine showNumber={false} indent={0}>
    **Entrada:** $s_0 \in S_0$
  </PseudoCodeLine>
  <PseudoCodeLine number={1}>
    <span>Salida:</span> $s_n = f(s_0)$
  </PseudoCodeLine>
  <PseudoCodeLine number={2}>
    <span>Para</span> $k = 1, \ldots, n$
  </PseudoCodeLine>
  <PseudoCodeLine number={3}>
    <span></span> $s_k = f_k(s_{i_1}, \ldots, s_{i_{p_k}})$
  </PseudoCodeLine>
  <PseudoCodeLine number={4}>
    <span>Fin</span>  $s_k = f_k(s_{i_1}, \ldots, s_{i_{p_k}})$
  </PseudoCodeLine>
</PseudoCode>
