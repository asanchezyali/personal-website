...
const Solana = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 36 36" width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <linearGradient x1="90.737%" y1="34.776%" x2="35.509%" y2="55.415%" id="solana-grad-1">
        <stop stopColor="#00FFA3" offset="0%" />
        <stop stopColor="#DC1FFF" offset="100%" />
      </linearGradient>
      <linearGradient x1="66.588%" y1="43.8%" x2="11.36%" y2="64.439%" id="solana-grad-2">
        <stop stopColor="#00FFA3" offset="0%" />
        <stop stopColor="#DC1FFF" offset="100%" />
      </linearGradient>
      <linearGradient x1="78.586%" y1="39.317%" x2="23.358%" y2="59.956%" id="solana-grad-3">
        <stop stopColor="#00FFA3" offset="0%" />
        <stop stopColor="#DC1FFF" offset="100%" />
      </linearGradient>
    </defs>
