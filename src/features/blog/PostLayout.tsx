          ...
          <div className="author">
            <div className="avatar">
              {author.avatar ? (
                ...
                <div
                  className="ph"
                  style={{ width: 28, height: 28, borderRadius: '50%', fontSize: 10 }}
                >
                  A
                </div>
              )}
        ...
        <div className="author-box">
          <div className="avatar">
            {author.avatar ? (
              ...
              <div className="ph" style={{ width: 64, height: 64, borderRadius: '50%' }}>
                A
              </div>
            )}
          </div>
          <div>
            <h4>{author.name}</h4>
            {author.occupation && (
              <p style={{ marginBottom: 8, fontWeight: 500, fontSize: 13, color: 'var(--p-600)' }}>
                {author.occupation}
              </p>
            )}
            <p>{t('authorBio')}</p>
