const quotesWithAuthorES = [
  ...
  {
    quote:
      'En la preparación para la batalla siempre he descubierto que los planes son inútiles, pero la planificación es indispensable',
...
const quotesWithAuthorEN = [
  ...
  {
    quote: 'Software is like sex it is better when it is free',
    author: 'Linus Torvalds',
  },
  {
    quote:
