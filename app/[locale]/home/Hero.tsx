...
const HeroSection = () => {
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-84px)] items-center justify-center px-4 sm:px-6 lg:px-8">
      {/* Main Content */}
      <motion.div
      ...
      >
        ...
        <motion.div className="flex-1 text-center lg:text-left" variants={childVariants}>
          ...
          <h1 className="mb-6 font-ubuntu text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-5xl lg:text-5xl">
            {t('hero.title_1')}
          </h1>

          <p className="mb-8 font-lato text-lg leading-relaxed text-gray-700 dark:text-gray-300 sm:text-xl">
            {t('hero.title_2')}
          </p>

          <div className="mb-8 flex flex-col items-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0 lg:justify-start">
            <a
              className="group inline-flex items-center rounded-lg bg-primary-600 px-6 py-2.5 text-sm font-medium text-white transition-all hover:bg-teal-600 dark:bg-primary-500 dark:hover:bg-teal-500"
            ...
            <a
              className="group inline-flex items-center rounded-lg bg-gray-200 px-6 py-2.5 text-sm font-medium text-gray-800 transition-all hover:bg-gray-300 hover:text-teal-700 dark:bg-white/10 dark:text-white dark:hover:bg-white/20 dark:hover:text-teal-300"
            ...
            >
              {t('hero.button_2')}
              <svg
                className="ml-2 h-4 w-4 transition-colors group-hover:text-teal-700 dark:group-hover:text-teal-300"
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
