...
const HeroSection = () => {
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-84px)] items-center justify-center bg-white px-4 dark:bg-black sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        <motion.div className="flex-1 text-center lg:text-left" variants={childVariants}>
          ...
          <div className="mb-8 flex flex-col items-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0 lg:justify-start">
            <a
              className="group inline-flex items-center rounded-lg bg-primary-600 px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600"
            ...
            <a
              className="group inline-flex items-center rounded-lg bg-gray-200 px-6 py-2.5 text-sm font-medium text-gray-800 transition-colors hover:bg-gray-300 hover:text-primary-600 dark:bg-white/10 dark:text-white dark:hover:bg-white/20 dark:hover:text-primary-400"
        ...
        <motion.div className="relative h-64 w-64 sm:h-80 sm:w-80 lg:h-96 lg:w-96" variants={childVariants}>
